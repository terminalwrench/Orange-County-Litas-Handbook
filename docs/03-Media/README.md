...
Use this folder with the event operating system in [../02-Events](../02-Events/README.md) and the existing production areas for flyers, social, photography, and brand references.
...
The [Assets](Assets/README.md) folder contains reusable source assets that support media production:
