...
<section class="module-hero">
  ...
  <h1>Operations</h1>
  <p class="module-subtitle">Repeatable procedures for annual planning, monthly work, handoffs, records, communication, and incident documentation.</p>
  <p class="module-intro">Use this module when leadership needs the practical operating layer that keeps the chapter organized from month to month.</p>
</section>
...
<div class="module-link-grid">
  ...
  <a href="Annual-Planning/">Annual Planning</a>
  <a href="Leadership-Handoff/">Leadership Handoff</a>
  <a href="Communication-Workflow/">Communication Workflow</a>
  <a href="Record-Retention/">Record Retention</a>
</div>

This module is the practical operations manual for running the Orange County Litas chapter. It focuses on recurring procedures: what needs to happen monthly, how events move through the system, how leadership transitions are handled, how records are kept, and how information is passed forward.
...
| Document | Purpose |
| --- | --- |
| [Annual-Planning.md](Annual-Planning.md) | Annual planning cycle and yearly operating review. |
| [Event-Lifecycle.md](Event-Lifecycle.md) | Operational workflow for moving events from idea to archive. |
...
| [Communication-Workflow.md](Communication-Workflow.md) | Internal communication and update workflow. |
...
| [Document-Management.md](Document-Management.md) | File organization and documentation upkeep. |
| [Digital-Assets.md](Digital-Assets.md) | Managing reusable and event-specific digital assets. |
| [Record-Retention.md](Record-Retention.md) | Practical retention guidance for handbook records. |

## Templates

- [Templates/Monthly-Checklist.md](Templates/Monthly-Checklist.md)
- [Templates/Incident-Report.md](Templates/Incident-Report.md)
- [Templates/Handoff-Checklist.md](Templates/Handoff-Checklist.md)
- [Templates/Operations-Review.md](Templates/Operations-Review.md)
