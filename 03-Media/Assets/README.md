...
| Folder | Use |
| --- | --- |
| [Logos](Logos/) | Official, chapter, partner, and sponsor logo files approved for current or repeatable use. |
| [Fonts](Fonts/) | Font files or font reference notes with license information when available. |
| [Icons](Icons/) | Reusable icons or utility graphics. |
